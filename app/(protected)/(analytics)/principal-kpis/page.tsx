...
export default function PrincipalKpisPage() {
  ...
  const { summary, periods = [], selectedPeriod = 1, fiscalYear = "", priorYear = "", byPeriod = [], bySeller = [], byBrand = [], source, priorSource, asOf } = data;
