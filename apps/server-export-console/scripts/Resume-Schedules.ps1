...
foreach($name in $names){Enable-ScheduledTask -TaskName $name -ErrorAction Stop|Out-Null}
Write-Output 'All UKL Nairobi and Nyeri scheduled exports are enabled.'
