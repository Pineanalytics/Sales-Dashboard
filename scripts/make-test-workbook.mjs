...
const SALES_HEADER = [
  "Principal", "Current Month Target", "MTD Target", "MTD Revenue", "Achieved Vs Full Target",
  "Achieved Vs MTD Target", "Balance Of Month", "Revenue LMSP", "MOM", "Revenue LYSP", "YOY",
  "YTD Revenue.", "Full Year Target", "YTD Variance", "YTD Vs Target", "H1 Sales.", "H1 Mission",
  "H1 Variance", "Average Sales", "Gross Profit.", "Gross Margin %", "Next Month Forecast", "Next Quarter Forecast",
];

const salesVsTargetRows = [
  [""],
...
const stockRows = [
  ...
  ["Weetabix-Meru", "Weetabix Original 500g", 20, 200, 8000, 400, 8, 0, ""],
  ["Total Balances", "", 90, 900, 15000, 4900, 43, 0, ""],
];

const MONTH_HEADER = ["", "", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

const trendedRevenueRows = [
  MONTH_HEADER,
  ...
  ["2025", "Weetabix", 20000, 22000, 21000, 23000, 24000, 23500, 25000, 26000, 25500, 27000, 28000, 30000],
  ["2026", "Weetabix", 23000, 24000, 25000, 26000, 27000, 28000, null, null, null, null, null, null],
...
writeFileSync(new URL("./test-workbook.xlsx", import.meta.url), buf);
console.log("wrote test-workbook.xlsx");
